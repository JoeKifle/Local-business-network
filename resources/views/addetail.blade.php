...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
       ...
       <header id="header-alt" class="clearfix" data-ma-theme="lightblue"> <!-- Make sure to change both class and data-current-skin when switching sking manually -->
            ...
            <nav class="ha-menu">
                <ul>
                    ...
                    <li class="active"><a href="{{ route('adapps') }}">AD APPLICATION</a></li>
                 ...
                 <div class="card" id="profile-main">
                        ...
                        <div class="pm-body clearfix" style="padding-left: 10px;">
                            <ul class="tab-nav tn-justified">
                                <li class="active"><a href="#">About ad  {{ $ad_inst->ad_title  }}</a></li>
                            </ul>


                            <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-format-size m-r-10"></i> Ad Title</h2>
                                </div>
                                <div class="pmbb-body p-l-30">
                                    <div class="pmbb-view">
                                         ...
                                         <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-view-week m-r-10"></i> Ad Content</h2>
                                </div>
                                <div class="pmbb-body p-l-30">
                                    <div class="pmbb-view">
                                          {{ $ad_inst->ad_desc  }}
                            ...
                            <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-aspect-ratio-alt m-r-10"></i> Ad Picture</h2>
                                </div>
  ...
  @if(\Illuminate\Support\Facades\Storage::disk('local')->has($user_inst->last_name.'-'.'adpic-'.$user_inst->SME_id.'.jpg'))

                                        {{ route('lnb.photo',['filename'=>$user_inst->last_name.'-'.'adpic-'.$user_inst->SME_id.'.jpg'])}}
      ...
      <img src=" @if(\Illuminate\Support\Facades\Storage::disk('local')->has($user_inst->last_name.'-'.'adpic-'.$user_inst->SME_id.'.jpg'))
                      ...
                      @if($ad_inst->ad_status=="accepted")

  <a href="{{  route('add.remove',['ad_id'=>$ad_inst->id])  }}" class="btn btn-danger btn-md waves-effect" style="float:right;margin-left:5px" >Stop Ad</a>

                      @endif

<a href="{{  route('add.accept',['ad_id'=>$ad_inst->id])  }}" class="btn btn-success btn-md waves-effect" style="float:right;margin-left:5px"

@if($ad_inst->ad_status == "accepted")
      disabled
   @endif >Accept Ad</a>
                            <a class="btn btn-warning btn-md waves-effect"  style="float:right;margin-left:5px">Suspend Ad</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                     <div id="todo" class="card card-light">
                                <div class="card-header ch-alt">
                                    <h2>Todo Lists <small>Add and manage your Todo Lists By Jobs</small></h2>
                                </div>
                                ...
                                <div class="card-body card-padding">
                                    <div class="t-add">
                                        ...
                                        <div class="ta-block">
                                          <form  action="addetail.blade.php" enctype="multipart/form-data">
                                            <textarea name="john" placeholder="What you want to do..."></textarea>



                                            <div class="tab-actions">
                                                <a data-ma-action="todo-form-close" href="" class="c-red"><i class="zmdi zmdi-close"></i></a>
                                                <input type="submit" data-ma-action="todo-form-close" href="" class="c-green"><i class="zmdi zmdi-check"></i></input>
                                            </div>
                                          </form>
