    ...
    <script>
        ...
        function showMapPic(long,lat,id){
           ...
           var altIm = "sme Location"
            ...
            var latlon = long + "," +lat;
  var img_url = "https://maps.googleapis.com/maps/api/staticmap?zoom=16&size=600x200&maptype=satellite&markers=color:red%7Clabel:C%7C"+latlon+"&key=AIzaSyDuYpJPqZrw8TPGjZuLSzOclIdbYIA3g-o";
   ...
   <img src="{{ route('user.profile',['filename'=>"lnbprofilepic-".$lnb->User->first_name."-".$lnb->id.".jpg"])}}" class="img-responsive m-b-15" alt="" style="width:600px;height:168px;">
                                ...
                                <div class="card-header bgm-bluegray" style="padding:12px 30px">
                                    ...
                                    <div class="card-body card-padding" style="6px 6px">
                                        <img src="
                                              ...
                                              {{ route('ad.pic',['ad_id'=>$ad->id])}}


                                    " class="img-responsive m-b-15" alt="">
                                        {{$ad->ad_content}}
