       ...
       <header id="header-alt" class="clearfix" data-ma-theme="lightblue"> <!-- Make sure to change both class and data-current-skin when switching sking manually -->
           ...
           <nav class="ha-menu">
               <ul>
                   ...
                   <li><a href="{{ route('smeapps') }}">SME APPLICATIONS</a></li>
                   <li><a href="{{ route('adapps') }}">AD APPLICATION</a></li>
                   <li class="active"><a href="{{ route('admin_messages') }}">Messages</a></li>
                        ...
                        <div class="table-responsive">
                             <table id="data-table-basic" class="table table-striped">
                                ...
                                @foreach($messages as $message)
                                    <tr>
                                    <td>{{ $message->id  }}</td>
                                    <td>{{\App\User::find($message->User_id)->first_name}} {{\App\User::find($message->User_id)->last_name}}</td>
                                    <td>{{\App\User::find($message->User_id)->phone}}</td>
                                    <td>{{ $message->message  }}</td>
                                        <td>{{$message->created_at}}</td>

                                    <td  @if($message->status == "unseen")
                                         style="color: green"
                                          @endif
                                    ...
                                    <td>
                                        <ul class="actions">
                                            <li>
                                                <a href="{{ route('aps.info',['app_id'=>$message->id]) }}">
