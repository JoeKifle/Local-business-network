    ...
    <section id="main">
            ...
            <section id="content" style="padding-left:0px">
                <div class="container container-alt" style="max-width: 1370px;">
                    ...
                    <div class="card" id="profile-main">
                        ...
                        <div class="pm-body clearfix">
                            <ul class="tab-nav tn-justified">
                                ...
                                <li class="active"><a href="{{ route('advertiseApp',['sme_id'=>$lnb->id]) }}">Adverise Apps</a></li>
                    ...
                    <form action="{{ route('adds.submitt') }}" method="post" enctype="multipart/form-data">
                                
                        <div class="col-sm-4">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-border-color"></i></span>
                                        <div class="fg-line">
                                            <input name="ad_title" type="text" class="form-control" placeholder="Ad Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-border-color"></i></span>
                                        <div class="fg-line">
                                            <input name="ad_subtitle" type="text" class="form-control" placeholder="Add Subtitle">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-border-color"></i></span>
                                        <div class="fg-line">
                                            <input name="ad_text" type="text" class="form-control" placeholder="Text Content">
                                        </div>
                                    </div>
    <br><br>
                              ...
                              <button
                                      @if($ads)
                                               disabled
                                         @endif
                                      type="submit" class="btn btn-success btn-lg waves-effect">Submit Ad Application</button>
                            ...
                            <input type="hidden" value="{{ Session::token() }}" name="_token">
                                ...
                                <div class="col-sm-4">
                                        ...
                                        @if($ads)
                                        <div class="alert alert-success" style="background-color: #84bb40" role="alert">

                                             You have an ad {{  $ads->ad_status  }} <span">{{ $ads->ad_title  }}</span>
                                         </div>
                                        <a href="{{ route('stop.ad',['ad_id'=>$ads->id])  }}" class="btn btn-danger btn-md waves-effect"> Stop Ad</a>
                                        @endif
