            ...
            <section id="content" class="content-alt" style="max-width: 99%;">
                <div class="container">
                 ...
                 <div class="card" id="profile-main">
                        ...
                        <div class="pm-body clearfix" style="padding-left: 10px;">
                            ...
                            <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-equalizer m-r-10"></i> Essay</h2>
                                </div>
                                ...
                                <div class="pmbb-body p-l-30">
                                    <div class="pmbb-view">
                                        <dl class="dl-horizontal">
                                            <dt>Business Title</dt>
                                            <dd>{{ $sme_app->Name }}</dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            <dt>Category</dt>
                                            <dd>{{  $sme_app->appCat  }}</dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            <dt>Quote</dt>
                                            <dd>{{ $sme_app->motto }}</dd>
                            ...
                            <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-phone m-r-10"></i> Require Documents</h2>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 col-md-6">
                                        <div class="thumbnail">
                                            @if(\Illuminate\Support\Facades\Storage::disk('local')->has($sme_app->Name.'-'.$sme_app->User_id.'.jpg'))

                                                <img src="{{route('users.legalId',['filename'=>$sme_app->Name.'-'.$sme_app->User_id.'.jpg'])}}" alt="">
                                    ...
                                    <div class="col-md-6 col-md-6">
                                        <div class="thumbnail">@if(\Illuminate\Support\Facades\Storage::disk('local')->has($sme_app->Name.'-'.$sme_app->User_id.'.jpg'))

           <img src="{{route('users.legalId',['filename'=>$sme_app->Name.'-'.'letter'.'-'.$sme_app->User_id.'.jpg'])}}" alt="">
                                ...
                                <div class="row">
                                    <div>
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                <h4>Add Location (Only if you are going to accept the Business)</h4>
                                    ...
                                    <div class="col-md-12 col-md-12">
                                        ...
                                        <form action="{{route('app.accept')}}" method="post" class="col s12">

                                            <div class="row">
                                                <div id="google-maps" style="height: 400px; width:100%"></div>

                                                <input type="hidden" name="sme_id" value="{{$sme_app->id}}">
                                                <input type="hidden" name="longitude" value="" />
                                                <input type="hidden" name="latitude" value="" />

                                                <br>
                              <button
                                      @if($sme_app->status =="accepted")
                                             disabled
                                       @endif

                                      type="submit" class="btn btn-success btn-md waves-effect">
                                  @if($sme_app->status =="accepted")
                                      Already Accepted
                                  @else
                                      Accept Business
                             ...
                             @if($sme_app->status == "pending..")
                                <a  href="#" class="btn btn-danger btn-md waves-effect"  style="float:right;margin-left:5px">Reject Application</a>
                                <a  href="#" class="btn btn-warning btn-md waves-effect"  style="float:right;margin-left:5px">Suspend Application</a>

                            @elseif($sme_app->status =="accepted")

                                <a  href="#" class="btn btn-danger btn-md waves-effect"  style="float:right;margin-left:5px">Send Notification </a>
                                <a  href="#" class="btn btn-warning btn-md waves-effect"  style="float:right;margin-left:5px">Suspend Enterprise</a>
